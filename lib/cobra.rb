...
require 'cobra/config'
require 'cobra/commit'
require 'cobra/build'
require 'cobra/campfire'
require 'cobra/server'

class Cobra
  attr_reader :user, :project, :url, :current_build, :last_build, :project_path
